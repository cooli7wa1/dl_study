...
ifdef MTK_CARRIEREXPRESS_PACK
 ifndef MTK_REGIONAL_OP_PACK
  ifeq ($(strip $(MTK_CARRIEREXPRESS_PACK)),la)
    ...
    MTK_REGIONAL_OP_PACK = OP03_SPEC0200_SEGDEFAULT OP05_SPEC0200_SEGDEFAULT OP06_SPEC0106_SEGDEFAULT OP07_SPEC0407_SEGDEFAULT OP08_SPEC0200_SEGDEFAULT OP11_SPEC0200_SEGDEFAULT OP15_SPEC0200_SEGDEFAULT OP16_SPEC0200_SEGDEFAULT OP18_SPEC0100_SEGDEFAULT
...
ifeq ($(strip $(MTK_HIFIAUDIO_SUPPORT)), yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.mtk_hifiaudio_support=1
endif
...
ifeq (yes,$(strip $(MTK_IRTX_SUPPORT)))
    PRODUCT_PROPERTY_OVERRIDES += config.disable_consumerir=0
...
ifeq (yes,$(strip $(MTK_IRTX_PWM_SUPPORT)))
    ...
    PRODUCT_PROPERTY_OVERRIDES += config.disable_consumerir=1
endif
endif
...
# Add for SES-Entitlement
ifeq ($(strip $(MTK_ENTITLEMENT_SUPPORT)), yes)
  PRODUCT_PACKAGES += Entitlement
  PRODUCT_PACKAGES += libeap-aka
endif
...
# Enable latch unsignaled buffer for SF
...
ifeq ($(strip $(MTK_YIQI_FONTS_FRAMEWORK_SUPPORT)), yes)
  ...
  PRODUCT_COPY_FILES += frameworks/base/lovelyfontsframework/clib/lib/libEngineBuilder.so:system/lib/libEngineBuilder.so
  ifneq ($(strip $(TARGET_CPU_ABI_LIST_64_BIT)),"")
    ...
    PRODUCT_COPY_FILES += frameworks/base/lovelyfontsframework/clib/lib64/libEngineBuilder.so:system/lib64/libEngineBuilder.so
  endif
...
PRODUCT_PACKAGES += logcat_vendor
...
ifeq ($(strip $(MTK_AAL_SUPPORT)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,vendor/mediatek/proprietary/frameworks/base/amsaal/ams_aal_config.xml:$(TARGET_COPY_OUT_VENDOR)/etc/ams_aal_config.xml:mtk)
endif
...
$(foreach f,$(wildcard $(patsubst %/Android.mk,%/makefile/product_*.mk,$(firstword $(MTK_MODEM_MODULE_MAKEFILES)))),\
...
PRODUCT_PROPERTY_OVERRIDES += debug.sf.enable_hwc_vds=1
...
ifeq (0x10000000,$(strip $(CUSTOM_CONFIG_MAX_DRAM_SIZE)))
